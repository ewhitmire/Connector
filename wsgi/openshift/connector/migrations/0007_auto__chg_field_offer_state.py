...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.state'
        db.alter_column(u'connector_offer', 'state', self.gf('django.db.models.fields.IntegerField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Offer.state'
        db.alter_column(u'connector_offer', 'state', self.gf('django.db.models.fields.CharField')(max_length=20))
