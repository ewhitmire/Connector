...
urlpatterns = patterns('',
    ...
    url(r'^skills/(?P<pk>\d+)$', SkillDetailView.as_view(), name='skills_detail_url'),
    url(r'^skills/(?P<pk>\d+)/update$', SkillUpdateView.as_view(), name='skills_update_url'),
    url(r'^skills/(?P<pk>\d+)/delete$', SkillDeleteView.as_view(), name='skills_delete_url'),
