...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'connector_offer_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('offer', models.ForeignKey(orm[u'connector.offer'], null=False)),
            ('tag', models.ForeignKey(orm[u'connector.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['offer_id', 'tag_id'])


    def backwards(self, orm):
        # Removing M2M table for field tags on 'Offer'
        db.delete_table(db.shorten_name(u'connector_offer_tags'))
