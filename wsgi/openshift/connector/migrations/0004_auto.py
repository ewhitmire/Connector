...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tags on 'Skill'
        m2m_table_name = db.shorten_name(u'connector_skill_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('skill', models.ForeignKey(orm[u'connector.skill'], null=False)),
            ('tag', models.ForeignKey(orm[u'connector.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['skill_id', 'tag_id'])


    def backwards(self, orm):
        # Removing M2M table for field tags on 'Skill'
        db.delete_table(db.shorten_name(u'connector_skill_tags'))
    ...
    models = {
        ...
        u'connector.skill': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['connector.Member']"}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['connector.Tag']", 'symmetrical': 'False'})
        },
        u'connector.tag': {
