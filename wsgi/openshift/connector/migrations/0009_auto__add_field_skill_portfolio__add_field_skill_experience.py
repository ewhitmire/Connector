...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.portfolio'
        db.add_column(u'connector_skill', 'portfolio',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Skill.experience'
        db.add_column(u'connector_skill', 'experience',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.portfolio'
        db.delete_column(u'connector_skill', 'portfolio')

        # Deleting field 'Skill.experience'
        db.delete_column(u'connector_skill', 'experience')
    ...
    models = {
        ...
        u'connector.offer': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['connector.Tag']", 'symmetrical': 'False', 'blank': 'True'}),
            'time': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'connector.skill': {
            'Meta': {'unique_together': "(('member', 'category'),)", 'object_name': 'Skill'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['connector.Category']"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'experience': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['connector.Member']"}),
            'portfolio': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['connector.Tag']", 'symmetrical': 'False', 'blank': 'True'})
        },
        u'connector.tag': {
