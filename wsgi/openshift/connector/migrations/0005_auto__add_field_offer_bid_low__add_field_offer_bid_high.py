...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'connector_offer', 'bid_low')

        # Deleting field 'Offer.bid_high'
        db.delete_column(u'connector_offer', 'bid_high')
